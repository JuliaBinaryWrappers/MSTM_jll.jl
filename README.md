# `MSTM_jll.jl` (v4.0.2+1)

[![deps](https://juliahub.com/docs/MSTM_jll/deps.svg)](https://juliahub.com/ui/Packages/MSTM_jll/NPq9p?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/1588899b035f027f76066c066897b57c6ce4b30f/M/MSTM/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `MSTM_jll.jl` have been built from these sources:

* git repository: https://github.com/dmckwski/MSTM.git (revision: `a33194e34e7929a4f3a00135388688e02085d4c5`)

## Platforms

`MSTM_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `MSTM_jll.jl`:
...
* `ExecutableProduct`: `mstm`
* `ExecutableProduct`: `mstm_serial`
